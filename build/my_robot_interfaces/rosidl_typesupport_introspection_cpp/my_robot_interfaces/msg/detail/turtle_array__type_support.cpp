...
size_t size_function__TurtleArray__turtlearray(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_robot_interfaces::msg::Turtle> *>(untyped_member);
  return member->size();
}

const void * get_const_function__TurtleArray__turtlearray(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TurtleArray__turtlearray(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurtleArray_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::TurtleArray, turtlearray),  // bytes offset in struct
    nullptr,  // default value
    size_function__TurtleArray__turtlearray,  // size() function pointer
    get_const_function__TurtleArray__turtlearray,  // get_const(index) function pointer
    get_function__TurtleArray__turtlearray,  // get(index) function pointer
    fetch_function__TurtleArray__turtlearray,  // fetch(index, &value) function pointer
    assign_function__TurtleArray__turtlearray,  // assign(index, value) function pointer
    resize_function__TurtleArray__turtlearray  // resize(index) function pointer
  }
};
