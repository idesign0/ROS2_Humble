...
size_t my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__size_function__TurtleArray__turtlearray(
...
const void * my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_const_function__TurtleArray__turtlearray(
...
void * my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_function__TurtleArray__turtlearray(
...
void my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__fetch_function__TurtleArray__turtlearray(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const my_robot_interfaces__msg__Turtle * item =
    ((const my_robot_interfaces__msg__Turtle *)
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_const_function__TurtleArray__turtlearray(untyped_member, index));
  my_robot_interfaces__msg__Turtle * value =
    (my_robot_interfaces__msg__Turtle *)(untyped_value);
  *value = *item;
}

void my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__assign_function__TurtleArray__turtlearray(
  void * untyped_member, size_t index, const void * untyped_value)
{
  my_robot_interfaces__msg__Turtle * item =
    ((my_robot_interfaces__msg__Turtle *)
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_function__TurtleArray__turtlearray(untyped_member, index));
  const my_robot_interfaces__msg__Turtle * value =
    (const my_robot_interfaces__msg__Turtle *)(untyped_value);
  *item = *value;
}

bool my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__resize_function__TurtleArray__turtlearray(
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__TurtleArray_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces__msg__TurtleArray, turtlearray),  // bytes offset in struct
    NULL,  // default value
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__size_function__TurtleArray__turtlearray,  // size() function pointer
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_const_function__TurtleArray__turtlearray,  // get_const(index) function pointer
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__get_function__TurtleArray__turtlearray,  // get(index) function pointer
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__fetch_function__TurtleArray__turtlearray,  // fetch(index, &value) function pointer
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__assign_function__TurtleArray__turtlearray,  // assign(index, value) function pointer
    my_robot_interfaces__msg__TurtleArray__rosidl_typesupport_introspection_c__resize_function__TurtleArray__turtlearray  // resize(index) function pointer
  }
};
