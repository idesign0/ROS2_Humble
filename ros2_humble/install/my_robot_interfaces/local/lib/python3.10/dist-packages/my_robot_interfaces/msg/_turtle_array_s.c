...
bool my_robot_interfaces__msg__turtle_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // turtlearray
    PyObject * field = PyObject_GetAttrString(_pymsg, "turtlearray");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'turtlearray'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    my_robot_interfaces__msg__Turtle * dest = ros_message->turtlearray.data;
...
PyObject * my_robot_interfaces__msg__turtle_array__convert_to_py(void * raw_ros_message)
{
  ...
  {  // turtlearray
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->turtlearray.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "turtlearray", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
