...
#include "my_robot_interfaces/msg/detail/turtle__functions.h"  // turtlearray
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: turtlearray
  {
    ...
    size_t size = ros_message->turtlearray.size;
    auto array_ptr = ros_message->turtlearray.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: turtlearray
  {
    ...
    if (ros_message->turtlearray.data) {
      my_robot_interfaces__msg__Turtle__Sequence__fini(&ros_message->turtlearray);
    }
    if (!my_robot_interfaces__msg__Turtle__Sequence__init(&ros_message->turtlearray, size)) {
      fprintf(stderr, "failed to create array for field 'turtlearray'");
      return false;
    }
    auto array_ptr = ros_message->turtlearray.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name turtlearray
  {
    size_t array_size = ros_message->turtlearray.size;
    auto array_ptr = ros_message->turtlearray.data;
