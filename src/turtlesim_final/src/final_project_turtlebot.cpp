...
namespace finalproject{
    ...
    {
    public:
    TurtleBotController(const rclcpp::NodeOptions &options) : LifecycleNode ("turtle_bot_controller",options ) 
        {
    ...
    private:
            ...
            //Goal Policy
            {
                ...
                if(goal_handle_){
                    if(goal_handle_->is_active()){
                        RCLCPP_WARN(this->get_logger(),"Current Goal is active");
                        return rclcpp_action::GoalResponse::REJECT;
                    }
                }
            }
        ...
        rclcpp_action::CancelResponse cancel_callback(std::shared_ptr<MoveTurtleGoalHandle>goal_handle){
...
RCLCPP_COMPONENTS_REGISTER_NODE(finalproject::TurtleBotController);