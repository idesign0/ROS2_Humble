...
#include "robot_arm_controller_hardware.hpp"
...
{
CallbackReturn RobotArmSystem::on_init(const hardware_interface::HardwareInfo & info)
{
...
std::vector<hardware_interface::StateInterface> RobotArmSystem::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> RobotArmSystem::export_command_interfaces()
{
...
return_type RobotArmSystem::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
...
return_type RobotArmSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
  return return_type::OK;
}
...
PLUGINLIB_EXPORT_CLASS(
  robot_arm_controller::RobotArmSystem, hardware_interface::SystemInterface)