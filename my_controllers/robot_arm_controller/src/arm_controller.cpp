...
#include "robot_arm_controller/arm_controller.hpp"
...
controller_interface::InterfaceConfiguration RobotArmController::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration RobotArmController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
...
controller_interface::CallbackReturn RobotArmController::on_configure(const rclcpp_lifecycle::State &)
{
  auto callback =
...
controller_interface::CallbackReturn RobotArmController::on_activate(const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn RobotArmController::on_deactivate(const rclcpp_lifecycle::State &)
{
  release_interfaces();
...
PLUGINLIB_EXPORT_CLASS(
  robot_arm_controller::RobotArmController, controller_interface::ControllerInterface)